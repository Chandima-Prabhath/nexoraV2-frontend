...
export function SpinnerLoadingProvider({ children }: { children: ReactNode }) {
    ...
    return (
        <LoadingContext.Provider value={{ spinnerLoading, setSpinnerLoading }} data-oid=".68hi:i">
            <AnimatePresence mode="wait" data-oid="0jvn.hf">
                {spinnerLoading && (
                    <motion.div
                        initial={{ opacity: 1 }}
                        exit={{ opacity: 0 }}
                        ...
                        data-oid="xkbxmy5"
                    >
                        <div className="relative flex flex-col items-center" data-oid="kn871a.">
                            {/* Loading Animation */}
                            <motion.div
                                animate={{ rotate: 360 }}
