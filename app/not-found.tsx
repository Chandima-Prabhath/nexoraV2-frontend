        ...
        >
            ...
            >
                <svg
                    ...
                    data-oid="ioi0kd:"
                >
                    <g id="SVGRepo_bgCarrier" stroke-width="0" data-oid="yl213vw"></g>
                    <g
                        ...
                        data-oid="j-qmz6x"
                    ></g>
                    <g id="SVGRepo_iconCarrier" data-oid="j0qe.zl">
                        {' '}
                        <g data-oid="dlmzfa-">
                            {' '}
                            <g data-oid="w:gdg:6">
            ...
            <p className="text-xl text-gray-400 mt-4" data-oid="mgu66nf">
